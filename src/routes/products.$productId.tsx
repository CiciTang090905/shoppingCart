...
function ProductPage() {
  ...
  const {
    ...
    queryKey: ["product", productId], //caches each product separately using Product
    //when navigating to a product seen before, data loads instantly from cache
    queryFn: () => fetchProduct(parsedProductId),
    enabled: !isInvalidProductId, //stop fetching when URL contains invalid product ID, avoids requests like /products/NaN
  });
